                    ...
                    <div class="modal-body">
                        <form id="form-login-submit" class="form-login" method="POST" action="./addNewUser.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <button style="margin-top: 4%" type="submit" name="register" class="btn btn-primary">Register</button>
                                <a style="margin-top: 4%; margin-left: 3%;" type="button" class="btn btn-outline-primary" href="./homeUser.php">Cancel</a>
