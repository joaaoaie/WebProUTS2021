                ...
                <div class="modal-content">
                    <div class="modal-header"> 
                        ...
                        <div style="float: right;">
                            <a type="button" class="btn btn-info" href="./loginUser.php">User</a>
                        </div>
                    </div>
                    <div class="modal-body">
                        <form id="form-login-submit" class="form-login" method="POST" action="./loginAdminCek.php"> <!-- action="<?= $base_url ?>/loginUserCek.php" -->
                            <div class="mb-3">
