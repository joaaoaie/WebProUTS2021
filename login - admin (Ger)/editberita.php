    ...
    <div class="card">
        ...
        <form method="POST" action="./act/addeditberita.php">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?=$result['judul']?>" placeholder="Judul" name="Judul">
            </div>
            <div class="mb-3">
                <label class="form-label">Kategori</label>
                <input type="text" class="form-control" value="<?=$result['kategori']?>" placeholder="kategori" name="Kategori">
            </div>
            <div class="mb-3">
                <label class="form-label">Penulis</label>
                <input type="text" class="form-control" value="<?=$result['penulis']?>" placeholder="Penulis" name="Penulis">
            </div>
            <div class="mb-3">
                <label class="form-label">Konten Berita</label>
                <input type="text" class="form-control" value="<?=$result['konten']?>" placeholder="Konten Berita" name="Konten">
            </div>
            <div class="mb-3">
