    ...
    <div class="card">
        ...
        <form method="POST" action="./act/adddataberita.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="idBerita" name="id">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Konten Berita" name="Konten">
            </div>
            <div class="mb-3">
                <label class="form-label">Tanggal Publikasi</label>
                <input type="date" class="form-control" placeholder="Tanggal Publikasi" name="Tanggal">
            </div>
            <div class="mb-3">
